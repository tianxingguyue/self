package com.job.common.exception.core;


import com.fasterxml.jackson.annotation.JsonFormat;
import com.job.core.exception.code.BaseExceptionCode;
...
public enum ExceptionCode implements BaseExceptionCode {
    ...
    VERIFY_KEY_NULL(50011, "验证码Key不能为空"),
    VERIFY_CODE_NULL(50012, "验证码不能为空"),
    VERIFY_NO_EXIST(50013, "验证码已失效"),
    VERIFY_CODE_ERROR(50014, "验证码错误"),
    APPLICATIONS_GET_FAIL(50015,"应用获取失败"),
    //权限相关 end
